set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { serin  }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { resetn }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { sh_ldn }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]
