...
HD_PWD='D:/fpga/kitap1b/25_parin_parout/25_parin_parout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parin_parout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parin_parout.tcl -notrace
