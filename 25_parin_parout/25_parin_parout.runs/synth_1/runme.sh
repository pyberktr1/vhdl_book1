...
HD_PWD='D:/fpga/kitap1b/25_parin_parout/25_parin_parout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parin_parout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parin_parout.tcl
