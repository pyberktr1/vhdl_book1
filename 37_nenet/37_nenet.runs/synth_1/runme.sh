...
HD_PWD='D:/fpga/kitap1b/37_nenet/37_nenet.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nenet.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nenet.tcl
