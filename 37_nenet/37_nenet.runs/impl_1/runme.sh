...
HD_PWD='D:/fpga/kitap1b/37_nenet/37_nenet.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nenet.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nenet.tcl -notrace
