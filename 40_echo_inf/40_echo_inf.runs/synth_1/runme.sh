...
HD_PWD='D:/fpga/kitap1b/40_echo_inf/40_echo_inf.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_inf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source echo_inf.tcl
