...
HD_PWD='D:/fpga/kitap1b/40_echo_inf/40_echo_inf.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log echo_inf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source echo_inf.tcl -notrace
