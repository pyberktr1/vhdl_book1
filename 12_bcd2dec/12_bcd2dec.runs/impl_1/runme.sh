...
HD_PWD='D:/fpga/kitap1b/12_bcd2dec/12_bcd2dec.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd2dec.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd2dec.tcl -notrace
