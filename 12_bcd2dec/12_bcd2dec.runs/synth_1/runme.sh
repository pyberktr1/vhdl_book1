...
HD_PWD='D:/fpga/kitap1b/12_bcd2dec/12_bcd2dec.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd2dec.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd2dec.tcl
