...
HD_PWD='D:/fpga/kitap1b/24_parin_serout/24_parin_serout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log parin_serout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source parin_serout.tcl
