...
HD_PWD='D:/fpga/kitap1b/24_parin_serout/24_parin_serout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log parin_serout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source parin_serout.tcl -notrace
