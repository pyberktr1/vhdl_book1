...
HD_PWD='D:/fpga/kitap1b/2_if_statements/2_if_statements.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log if_statements.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source if_statements.tcl
