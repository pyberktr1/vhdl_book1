...
HD_PWD='D:/fpga/kitap1b/2_if_statements/2_if_statements.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log if_statements.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source if_statements.tcl -notrace
