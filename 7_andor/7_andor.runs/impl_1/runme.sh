...
HD_PWD='D:/fpga/kitap1b/7_andor/7_andor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log andor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source andor.tcl -notrace
