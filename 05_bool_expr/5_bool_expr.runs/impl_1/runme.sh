...
HD_PWD='D:/fpga/kitap1b/5_bool_expr/5_bool_expr.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bool_expr.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bool_expr.tcl -notrace
