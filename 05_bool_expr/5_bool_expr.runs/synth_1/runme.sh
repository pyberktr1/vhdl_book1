...
HD_PWD='D:/fpga/kitap1b/5_bool_expr/5_bool_expr.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bool_expr.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bool_expr.tcl
