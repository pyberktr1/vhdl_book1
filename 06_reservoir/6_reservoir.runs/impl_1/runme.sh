...
HD_PWD='D:/fpga/kitap1b/6_reservoir/6_reservoir.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log reservoir.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source reservoir.tcl -notrace
