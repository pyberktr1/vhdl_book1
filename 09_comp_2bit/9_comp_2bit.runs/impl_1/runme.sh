...
HD_PWD='D:/fpga/kitap1b/9_comp_2bit/9_comp_2bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_2bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_2bit.tcl -notrace
