...
HD_PWD='D:/fpga/kitap1b/31_bcd_module/31_bcd_module.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_module.tcl
