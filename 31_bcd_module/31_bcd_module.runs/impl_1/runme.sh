...
HD_PWD='D:/fpga/kitap1b/31_bcd_module/31_bcd_module.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_module.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_module.tcl -notrace
