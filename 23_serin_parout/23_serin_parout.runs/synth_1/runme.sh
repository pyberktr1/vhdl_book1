...
HD_PWD='D:/fpga/kitap1b/23_serin_parout/23_serin_parout.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log serin_parout.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source serin_parout.tcl
