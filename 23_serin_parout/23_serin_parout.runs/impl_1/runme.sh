...
HD_PWD='D:/fpga/kitap1b/23_serin_parout/23_serin_parout.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log serin_parout.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source serin_parout.tcl -notrace
