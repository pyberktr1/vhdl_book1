...
HD_PWD='D:/fpga/kitap1b/3_cases/3_cases.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log cases.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cases.tcl
