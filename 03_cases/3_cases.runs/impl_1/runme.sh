...
HD_PWD='D:/fpga/kitap1b/3_cases/3_cases.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log cases.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source cases.tcl -notrace
