...
HD_PWD='D:/fpga/kitap1b/14_mux_8x1/14_mux_8x1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_8x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux_8x1.tcl -notrace
