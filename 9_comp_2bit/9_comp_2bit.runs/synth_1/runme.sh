...
HD_PWD='D:/fpga/kitap1b/9_comp_2bit/9_comp_2bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_2bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_2bit.tcl
