...
HD_PWD='D:/fpga/kitap1b/35_codelock_alt/35_codelock_alt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codelock_alt.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codelock_alt.tcl -notrace
