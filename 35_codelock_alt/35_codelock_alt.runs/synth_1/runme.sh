...
HD_PWD='D:/fpga/kitap1b/35_codelock_alt/35_codelock_alt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codelock_alt.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codelock_alt.tcl
