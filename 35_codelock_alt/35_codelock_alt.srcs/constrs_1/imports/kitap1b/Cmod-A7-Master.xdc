...
set_property -dict { PACKAGE_PIN U1    IOSTANDARD LVCMOS33 } [get_ports { digit[2] }]; #IO_L3N_T0_DQS_34 Sch=pio[31]
set_property -dict { PACKAGE_PIN W2    IOSTANDARD LVCMOS33 } [get_ports { digit[3] }]; #IO_L5N_T0_34 Sch=pio[32]
