...
HD_PWD='D:/fpga/kitap1b/10_comp_2bit_ver2/10_comp_2bit_ver2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_2bit_ver2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_2bit_ver2.tcl -notrace
