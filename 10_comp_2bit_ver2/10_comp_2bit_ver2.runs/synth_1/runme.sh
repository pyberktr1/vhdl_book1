...
HD_PWD='D:/fpga/kitap1b/10_comp_2bit_ver2/10_comp_2bit_ver2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_2bit_ver2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comp_2bit_ver2.tcl
