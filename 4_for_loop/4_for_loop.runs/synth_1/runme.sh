...
HD_PWD='D:/fpga/kitap1b/4_for_loop/4_for_loop.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log for_loop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source for_loop.tcl
