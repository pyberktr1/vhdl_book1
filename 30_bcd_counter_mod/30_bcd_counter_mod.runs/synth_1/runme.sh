...
HD_PWD='D:/fpga/kitap1b/30_bcd_counter_mod/30_bcd_counter_mod.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_counter_mod.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bcd_counter_mod.tcl
