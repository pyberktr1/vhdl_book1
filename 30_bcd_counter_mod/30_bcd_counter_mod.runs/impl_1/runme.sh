...
HD_PWD='D:/fpga/kitap1b/30_bcd_counter_mod/30_bcd_counter_mod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bcd_counter_mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bcd_counter_mod.tcl -notrace
