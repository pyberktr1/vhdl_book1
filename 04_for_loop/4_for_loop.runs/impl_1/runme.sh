...
HD_PWD='D:/fpga/kitap1b/4_for_loop/4_for_loop.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log for_loop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source for_loop.tcl -notrace
