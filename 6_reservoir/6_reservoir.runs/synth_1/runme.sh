...
HD_PWD='D:/fpga/kitap1b/6_reservoir/6_reservoir.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log reservoir.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source reservoir.tcl
