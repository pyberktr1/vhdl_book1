...
HD_PWD='D:/fpga/kitap1b/22_oneshot_wed/22_oneshot_wed.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oneshot.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oneshot.tcl -notrace
