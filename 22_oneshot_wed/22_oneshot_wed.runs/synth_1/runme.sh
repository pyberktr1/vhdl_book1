...
HD_PWD='D:/fpga/kitap1b/22_oneshot_wed/22_oneshot_wed.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oneshot.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oneshot.tcl
