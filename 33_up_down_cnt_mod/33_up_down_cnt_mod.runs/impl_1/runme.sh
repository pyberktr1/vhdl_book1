...
HD_PWD='D:/fpga/kitap1b/33_up_down_cnt_mod/33_up_down_cnt_mod.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log up_down_cnt_mod.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source up_down_cnt_mod.tcl -notrace
