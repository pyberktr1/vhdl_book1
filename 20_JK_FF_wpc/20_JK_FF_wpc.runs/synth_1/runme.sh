...
HD_PWD='D:/fpga/kitap1b/20_JK_FF_wpc/20_JK_FF_wpc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_FF_wpc.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source JK_FF_wpc.tcl
