...
HD_PWD='D:/fpga/kitap1b/20_JK_FF_wpc/20_JK_FF_wpc.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log JK_FF_wpc.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source JK_FF_wpc.tcl -notrace
