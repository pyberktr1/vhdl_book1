...
HD_PWD='D:/fpga/kitap1b/34_codelock/34_codelock.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codelock.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codelock.tcl
