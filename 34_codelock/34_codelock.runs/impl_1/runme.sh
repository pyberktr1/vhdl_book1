...
HD_PWD='D:/fpga/kitap1b/34_codelock/34_codelock.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log codelock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source codelock.tcl -notrace
