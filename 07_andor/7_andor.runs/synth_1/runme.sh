...
HD_PWD='D:/fpga/kitap1b/7_andor/7_andor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log andor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source andor.tcl
