...
HD_PWD='D:/fpga/kitap1b/38_s_mult/38_s_mult.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log s_mult.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source s_mult.tcl -notrace
