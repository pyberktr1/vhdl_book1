...
HD_PWD='D:/fpga/kitap1b/38_s_mult/38_s_mult.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log s_mult.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source s_mult.tcl
