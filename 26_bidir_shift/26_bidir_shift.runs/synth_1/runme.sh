...
HD_PWD='D:/fpga/kitap1b/26_bidir_shift/26_bidir_shift.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bidir_shift.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bidir_shift.tcl
