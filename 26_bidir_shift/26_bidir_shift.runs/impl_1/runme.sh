...
HD_PWD='D:/fpga/kitap1b/26_bidir_shift/26_bidir_shift.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bidir_shift.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bidir_shift.tcl -notrace
